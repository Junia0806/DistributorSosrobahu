            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg shadow-md p-4">
                        ...
                        <select id="year-filter-omset"
                            class="mb-4 block w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
        ...
        <script>
            ...
            const omsetChart = new Chart(ctxOmset, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Omset (Rp)',
                        data: [12000000, 15000000, 13000000, 16000000, 17000000, 18000000, 14000000, 19000000,
