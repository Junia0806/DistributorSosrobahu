            ...
            <table class="w-full border-separate border-spacing-0">
                ...
                <tbody class="bg-white text-sm">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="px-4 py-2">{{ 'Rp ' . number_format($rokok->harga_distributor, 0, ',', '.') }}</td>
                        <td class="px-4 py-2">
                            <button type="button"
...
<div id="editModal" style="display: none;"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form id="editForm" method="POST" action="{{ route('pengaturanHargaDistributor.update', ['id' => $rokok->id_barang_distributor]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="harga_distributor" id="harga_distributor" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                    required>
            </div>
