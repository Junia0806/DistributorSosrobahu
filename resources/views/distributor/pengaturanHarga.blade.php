        ...
        @elseif ($newProductsCount > 0)
            ...
            <div class="mb-6 p-4 bg-yellow-100 border-l-4 border-yellow-400 rounded-lg flex items-center space-x-2 shadow-lg"
                ...
                <p class="text-gray-700">
                    ...
                    <a href="{{ route('showAddProductDistributor') }}"
                        class="text-red-500 font-semibold underline">disini</a>
                    untuk menambahkan.
                </p>
            </div>
        @endif
                        ...
                        @else
                            @foreach ($rokokDistributors as $index => $rokok)
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2">
                                        {{ 'Rp ' . number_format($rokok->harga_distributor, 0, ',', '.') }}
                                    </td>
                                    <td class="px-4 py-2">
                                        <button type="button"
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
                                        ...
                                        <form id="editForm" method="POST"
                                            ...
                                            <div class="flex justify-end space-x-2 mt-4">
                                                ...
                                                <button type="button"
                                                    class="bg-red-800 text-white px-4 py-2 rounded hover:bg-red-700"
