...
<body class="flex items-center justify-center min-h-screen bg-gray-900">
    <div class="w-full max-w-sm mx-auto p-8 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-gray-900 text-center mb-6">Login Distributor</h2>
        <p class="text-sm text-gray-600 text-center mb-6">Masuk dengan akun yang diberikan oleh <br> Official CV. Santoso Jaya Tembakau</p>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">Belum punya akun? Bergabunglah menjadi Distributor Resmi Sosrobahu</p>
        </div>
    </div>
