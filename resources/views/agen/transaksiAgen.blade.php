                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="p-2">
                                ...
                                @elseif ($pesananMasuk->status_pemesanan == 0)
                                    <button
                                        onclick="window.location.href='{{ route('detailPesanMasuk', $pesananMasuk->id_order) }}'"
        ...
        @if ($pesananMasuks->total() > 10)
            <div class="flex flex-col items-center my-6">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-400">
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $pesananMasuks->total() }}</span>
                    transaksi
                </span>
                <!-- Buttons -->
