...
@section('content')
    <div class="w-full max-w-6xl mx-auto bg-white rounded-lg shadow-lg overflow-x-auto my-20 text-md">
        ...
        <div id="orderDetails" class="p-6">
            <p class="mb-2 text-gray-700">Nama: <span id="agenName" class="font-semibold">{{ $pesanMasukAgen['nama_sales'] }}</span></p>
            ...
            <table class="w-full mb-4">
                ...
                <tfoot class="bg-gray-100">
                    <tr>
                        ...
                        <td class="p-2 text-right font-semibold" id="total-amount">Rp {{ number_format($pesanMasukAgen['total_harga'],0, ',', '.') }}</td>
                    </tr>
                </tfoot>
            </table>
