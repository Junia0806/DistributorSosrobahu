            ...
            @if ($barangAgens->isEmpty())
                <div class="mb-6 p-4 bg-red-100 border-l-4 border-red-500 rounded-lg flex items-center space-x-2 shadow-lg"
                    ...
                    <p class="text-gray-700">
                        Tidak ada produk yang tersedia saat ini. Silakan tambahkan produk baru dengan klik
                    ...
                    @foreach ($barangAgens as $index => $barang)
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-gray-700 text-md">Stok: <span class="text-black font-bold">
                                        {{ number_format($totalProdukList[$index], 0, ',', '.') }}
                                        Slop</span></p>
                            </div>
                        </div>
                    @endforeach
