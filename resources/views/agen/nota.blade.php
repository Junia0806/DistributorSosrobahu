        ...
        <div class="bg-nota bg-center bg-no-repeat bg-cover rounded-lg shadow-lg px-8 py-6 max-w-3xl mx-auto">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="text-gray-700 text-right">
                    ...
                    <div class="text-sm">INVO/SOSRO/05</div>
                    <div class="text-sm">Distributor Enrique Lazuardi</div>
                </div>
            </div>
            ...
            <div class="border-t-2 border-gray-300 pt-8">
              <p class="text-gray-600 mb-2">Kami menghargai kepercayaan Anda dalam bermitra dengan kami.</p>
              <p class="text-gray-600">Untuk informasi lebih lanjut atau pertanyaan terkait pesanan Anda, silakan menghubungi distributor kami melalui WhatsApp di
                  <a href="https://wa.me/6289938328392" class="text-blue-500 underline" target="_blank">089-9383-28392</a>. Kami selalu siap membantu Anda.
              </p>
          </div>
