        ...
        <table class="w-full border-separate border-spacing-0 text-sm text-black">
            ...
            <tbody class="bg-white text-center">
                ...
                <tr class="border-b border-gray-200">
                    ...
                    <td class="p-2">
                        <button type="button" data-modal-target="ktp-modal-{{ $akunSale->id_user_sales }}" data-modal-toggle="ktp-modal-{{ $akunSale->id_user_sales }}"
                    ...
                    <td class="p-2 font-semibold">Rp.{{ number_format($totalPricePerSales[$akunSale->id_user_sales] ?? 0, 0, ',', '.') }}</td>
                    <td class="p-2">
                        <div class="flex justify-center space-x-2">
                            <button type="button" data-modal-target="edit-akun-modal-{{ $akunSale->id_user_sales }}" data-modal-toggle="edit-akun-modal-{{ $akunSale->id_user_sales }}"
                ...
                <div id="ktp-modal-{{ $akunSale->id_user_sales }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow">
                            ...
                            <div class="p-4">
                                <img src="{{ asset('storage/ktp/' . $akunSale->gambar_ktp) }}" alt="KTP {{ $akunSale->nama_lengkap }}" class="w-full rounded-lg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Modal Edit Akun -->
                <div id="edit-akun-modal-{{ $akunSale->id_user_sales }}" tabindex="-1" aria-hidden="true" class="hidden fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto h-modal">
                    <div class="relative w-full h-full max-w-md md:h-auto">
                        <div class="relative bg-white rounded-lg shadow">
                            <div class="flex items-center justify-between p-4 border-b">
                                <h3 class="text-lg font-semibold text-black">Edit Akun</h3>
                                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center" data-modal-toggle="edit-akun-modal-{{ $akunSale->id_user_sales }}">
                            ...
                            <form action="{{ route('pengaturanSales.update', $akunSale->id_user_sales) }}" id="edit-akun-form" class="p-4" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" value="{{ $akunSale->nama_lengkap }}" name="nama_lengkap" id="nama_lengkap" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                                    </div>
                                    <div class="col-span-2">
                                        <label for="edit-username" class="block mb-2 text-sm font-medium text-black">Username</label>
                                        <input type="text" value="{{ $akunSale->username }}" name="username" id="username" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                                    </div>
                                    <div class="col-span-2">
                                        <label for="edit-password" class="block mb-2 text-sm font-medium text-black">Password</label>
                                        <input type="text" value="Masukkan  Password Baru Anda" name="password" id="password" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                                    </div>
                                    <div class="col-span-2">
                                        <label for="edit-phone" class="block mb-2 text-sm font-medium text-black">No. Telepon</label>
                                        <input type="tel" value="{{ $akunSale->no_telp }}" name="no_telp" id="no_telp" class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" required>
                                    </div>
                                    <div class="col-span-2">
                                        <label for="edit-avatar" class="block mb-2 text-sm font-medium text-gray-90">KTP</label>
                                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" aria-describedby="edit-avatar_help" name="gambar_ktp" id="gambar_ktp" type="file" />
                                    </div>
            ...
            <form action="{{ route('pengaturanSales.input') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="file" id="gambar_ktp" name="gambar_ktp" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" />
                    </div>
                </div>
