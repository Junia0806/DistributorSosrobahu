    ...
    <section class="relative w-full py-16 bg-gray-900 pt-24">
        <div class="container mx-auto flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="w-full md:w-1/2 text-center md:text-left text-white px-4">
                <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 text-gray-100">Peluang Bisnis Bersama
                    Santosojaya
                    Tembakau</h1>
            ...
            <div class="w-full md:w-1/2 aspect-w-16 aspect-h-9">
                <iframe class="w-full h-56 sm:h-72 md:h-96 lg:h-[450px] rounded-lg shadow-lg"
                    src="https://www.youtube.com/embed/evMpn8QH3mw?autoplay=1&mute=1&controls=1" frameborder="0"
    ...
    <section id="peluang-bisnis" class="container mx-auto py-20 px-4 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white text-gray-800 rounded-xl shadow-lg p-6 hover:scale-105 transition duration-300">
                <div class="mb-6">
                    <img src="https://img.freepik.com/free-vector/ecommerce-campaign-concept-illustration_114360-8202.jpg?ga=GA1.1.2088420924.1731607219&semt=ais_hybrid"
                        alt="Sales" class="w-full h-48 object-cover rounded-lg">
                </div>
            ...
            <div class="bg-white text-gray-800 rounded-xl shadow-lg p-6 hover:scale-105 transition duration-300">
                <div class="mb-6">
                    <img src="https://img.freepik.com/free-vector/checking-boxes-concept-illustration_114360-2429.jpg?ga=GA1.1.2088420924.1731607219&semt=ais_hybrid"
                        alt="Agen" class="w-full h-48 object-cover rounded-lg">
                </div>
            ...
            <div class="bg-white text-gray-800 rounded-xl shadow-lg p-6 hover:scale-105 transition duration-300">
                <div class="mb-6">
                    <img src="https://img.freepik.com/free-vector/warehouse-outside-concept-illustration_114360-29135.jpg?ga=GA1.1.2088420924.1731607219&semt=ais_hybrid"
                        alt="Distributor" class="w-full h-48 object-cover rounded-lg">
                </div>
