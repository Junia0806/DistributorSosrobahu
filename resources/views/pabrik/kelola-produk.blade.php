                ...
                <tbody class="bg-white text-sm">
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="px-4 py-2">
                                <img src="{{ asset('assets/images/produk' . $i . '.jpg') }}" alt="Sosrobahu Mangga Alpukat"
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form id="addProductForm">
            <div class="mb-4">
                ...
                <input type="text" id="newProductName" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                    required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="newProductSlop" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"
                    required>
            </div>

            <div class="mb-4">
                <label for="newProductImage" class="block text-sm font-medium text-gray-700">Foto Produk</label>
                <input type="file" id="newProductImage" class="mt-1 block w-full border border-gray-300 rounded-md"
                    accept="image/*">
            </div>
            <div class="flex justify-end space-x-2 mt-4">
                <button type="submit"
