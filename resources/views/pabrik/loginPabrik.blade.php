...
<body class="flex items-center justify-center min-h-screen bg-gray-900">
    <div class="w-full max-w-sm mx-auto p-8 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-gray-900 text-center mb-6">Login Pabrik</h2>
        <p class="text-sm text-gray-600 text-center mb-6">Masuk dengan akun yang telah tersedia</p>

        <form action="{{ route('loginPabrik') }}" method="POST" class="space-y-5">
            @csrf
            <div>
            ...
            <div class="relative">
                ...
                <span id="togglePassword" class="text-gray-500 absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer"
            ...
            <div>
                <button type="submit"
                    class="w-full py-2.5 text-sm font-medium text-white bg-gray-800 rounded-lg hover:bg-gray-700 focus:ring-2 focus:ring-gray-500">
                    Login
                </button>
            </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">Belum punya akun? Hubungi Admin untuk mendapatkan akun.</p>
        </div>
    </div>
