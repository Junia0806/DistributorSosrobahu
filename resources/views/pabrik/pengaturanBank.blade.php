        ...
        <div id="account-info" class="mb-6">
            ...
            <div class="mb-6 p-4 bg-blue-100 border border-blue-400 rounded-lg flex items-center space-x-2">
                ...
                <p class="text-gray-700">
                    Berikut adalah informasi rekening <strong>Official CV. Santoso Jaya Tembakau</strong>. Semua
                    transaksi dari Distributor akan menggunakan nomor rekening ini.
                </p>
            </div>
            <div class="mb-4">
        ...
        <form action="{{ route('rekeningBankPabrik.update') }}" id="account-form" class="hidden" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="bank_name" name="bank_name"
                    ...
                    <option value="Bank Mandiri" {{ $userPabrik['nama_bank'] == 'Bank Mandiri' ? 'selected' : '' }}>Bank
                        Mandiri</option>
                    <option value="Bank BCA" {{ $userPabrik['nama_bank'] == 'Bank BCA' ? 'selected' : '' }}>Bank BCA
                    </option>
                    <option value="Bank BNI" {{ $userPabrik['nama_bank'] == 'Bank BNI' ? 'selected' : '' }}>Bank BNI
                    </option>
                </select>
            </div>
