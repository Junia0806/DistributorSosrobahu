...
@section('content')
    <section class="container mx-auto py-6 my-20">
        <div class="bg-white shadow-lg rounded-lg p-3">
            ...
            <p class="text-center text-gray-600 mb-6">Silakan klik produk yang ingin Anda pesan, lalu tekan tombol "Lanjutkan
                Pesanan" untuk melanjutkan proses pembelian.</p>
                        ...
                        <label class="relative block cursor-pointer">
                            ...
                            <div
                                ...
                                <div class="relative mb-2">
                                    <img src="{{ asset('storage/produk/' . $gambarRokokList[$index]) }}" alt="{{ $barang->nama_rokok }}"
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-gray-600 text-sm">Rp
                                        {{ number_format($barang->harga_agen, 0, ',', '.') }}</p>
                                </div>
                            </div>
                        </label>
                    @endforeach
