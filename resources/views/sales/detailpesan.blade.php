    ...
    <section class="container mx-auto p-6 relative">
        ...
        <section class="p-6 border rounded-lg bg-gray-100">
                        ...
                        <td class="p-3 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <button class="bg-gray-700 text-white text-sm px-2 py-0.5 rounded hover:bg-gray-600"
                                    ...
                                    <input type="text" id="sosrobahu-kopi-hitam-quantity" class="w-16 sm:w-24 text-center py-1 border rounded" value="1" oninput="updatePrices()">
                                <button class="bg-gray-700 text-white text-sm px-2 py-0.5 rounded hover:bg-gray-600"
                                    onclick="changeQuantity('sosrobahu-kopi-hitam', 1)">+</button>
                            </div>
                        </td>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="p-3 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <input type="text" id="sosrobahu-dh-quantity" class="w-16 sm:w-24 text-center py-1 border rounded" value="1" min="1" oninput="updatePrices()">
                                <button class="bg-gray-700 text-white text-sm px-2 py-0.5 rounded hover:bg-gray-600"
                                    onclick="changeQuantity('sosrobahu-dh', 1)">+</button>
                            </div>
                        </td>
            ...
            <div class="mb-4 p-4 bg-yellow-100 border border-yellow-400 rounded-lg flex items-center space-x-3">
                ...
                <p class="text-gray-700">Harap melakukan pembayaran sejumlah <span id="total-amount2">Rp. 300.000</span> melalui transfer BRI 981-628-262 a/n Bapak Adi Sucipto dan upload bukti pembayaran di bawah ini.</p>
            </div>

            <!-- Upload Bukti Pembayaran -->
            <div class="mb-4">
                <label for="payment-proof" class="block text-gray-800 text-lg font-semibold mb-2">Upload Bukti Pembayaran:</label>
                <div class="relative">
                    <input type="file" id="payment-proof" name="payment-proof" accept="image/*,application/pdf" class="border border-gray-300 rounded-lg py-2 px-3 w-full bg-white text-gray-700 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="text-right">
                <button id="order-button" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700" onclick="showConfirmation()">Pesan</button>
            </div>
        </section>
    </section>
