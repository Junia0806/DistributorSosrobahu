                        ...
                        <td colspan="6" class="text-center p-6">
                            <div class="flex flex-col items-center">
                                <div class="bg-gray-100 p-4 rounded-lg shadow-md">
                                    <h2 class="text-lg font-semibold text-gray-800">Belum ada riwayat pemesanan</h2>
                                    <p class="text-sm text-gray-600 mt-2">Saat ini Anda belum memiliki riwayat pemesanan.
                                        Silakan lakukan pemesanan untuk melihat riwayat Anda di sini.</p>
                                </div>
                            </div>
                        </td>
                    </tr>
