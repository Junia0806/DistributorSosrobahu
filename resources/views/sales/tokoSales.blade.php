...
<div class="w-full max-w-6xl mx-auto bg-white rounded-lg shadow-lg overflow-x-auto mt-20">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-6 text-center">
                                    ...
                                    <form action="{{ route('tokoSales.update', $item->id_daftar_toko) }}" method="POST"
                                        ...
                                        <div class="text-left mt-4">
                                            <label for="nama_pemilik" class="block text-sm font-medium text-gray-900">Nama
                                                Pemilik</label>
    ...
    @if ($toko->isEmpty())
        <div class="text-center p-6 my-6 mx-6 bg-yellow-100 border border-yellow-300 text-yellow-800 rounded-lg mb-6">
            <p class="text-lg font-semibold">Belum ada toko yang terdaftar.</p>
            <p class="mt-2">Silakan tambahkan toko baru dengan menekan tombol "Tambah Toko".</p>
        </div>
    @endif
